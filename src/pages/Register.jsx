    ...
    <> 
      <div className="login-container">
        ...
        <div className="login-right">
          ...
          <p>Ingresa los datos para registrarte en MiEstaciona y mantente al tanto de las últimas noticias, horarios y actualizaciones de nuestro estacionamiento.</p>
